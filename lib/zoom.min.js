    ...
    var p, v = {
        ...
        init: function(a) {
            ...
            if (!a.flipbook || !a.flipbook.turn("is"))
                throw t("options.flipbook is required");
        ...
        _tap: function(a) {
            var b = f(this)
              , d = b.data().zoom;
            !d.draggingCorner && !d.dragging && q(f(a.target), b) && (j._addEvent.call(b, "tap", a),
        ...
        zoomIn: function(a) {
            ...
            var q = function() {
                ...
                if (p && e.turn("display") == "double" && (e.turn("direction") == "ltr" && !e.turn("view")[0] || e.turn("direction") == "rtl" && !e.turn("view")[1]))
                    d.axis.x = d.axis.x + e.width() / 2;
                b.zoom("scroll", o);
